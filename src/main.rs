...
fn render_board_cells(canvas: &mut render::Canvas<video::Window>, background_texture: &mut render::Texture) {
...
fn main() {
    ...
    let window = video_subsystem.window("chess-engine", 800, 600)
        .build().unwrap();
